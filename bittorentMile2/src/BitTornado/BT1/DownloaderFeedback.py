...
class DownloaderFeedback:
    def __init__(self, choker, httpdl, add_task, upfunc, downfunc,
            ...
            _streamWatcher,_piecePicker,statusfunc = None, interval = None  ):
        self.choker = choker
        self.httpdl = httpdl
        ...
        ###### GROUP VOD ######
        self.streamWatcher = _streamWatcher
        self.picker = _piecePicker
        #######################
        if statusfunc:
    ...
    def gather(self, displayfunc = None):
        ...
        if desired > 0:
            ...
            s['frac'] = 1.0
        self.streamWatcher.p2p=int(s['frac']*100)
        if desired == obtained:
            s['time'] = 0
        else:
